            ...
            {back ? (
              ...
              <>
                ...
                <div className="b-galleryDetail">
                  ...
                  <div className="b-btn">
                    <button className="b-btn__buy" onClick={setBuy(true)}>
                      Comprar
                    </button>
                  ...
                  <div className="b-info4">
                    ...
                    <p className="b-info4__friends">
                      {event.assistants} Amigos
                    </p>
                  </div>
...
=======
            ...
            <div className="b-galleryDetail">
              ...
              <div className="b-btn">
                <button className="b-btn__buy" onClick={() => onPurchase()}>
                  Comprar
                </button>
                <button className="b-btn__share">Compartir</button>
              </div>
